    ...
    Plugin.prototype = {
        ...
        _setupColumns: function (elem, options) {
            ...
            var setupStyles = function (waitForImagesLoaded) {
                ...
                var $cols6 = $(elem).find('.cols-6 .photoset-cell');
                var $cols7 = $(elem).find('.cols-7 .photoset-cell');
                var $cols8 = $(elem).find('.cols-8 .photoset-cell');
                ...
                $cols4.css({'width': '25%'});
                $cols5.css({'width': '20%'});
                $cols6.css({'width': '16.6%'});
                $cols7.css({'width': '14.3%'});
                $cols8.css({'width': '12.5%'});
