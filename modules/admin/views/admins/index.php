...
?>
                        ...
                        <?= Html::beginForm(['admins/bulk'], 'post'); ?>
                            <div class="col-lg-4"></div>
                            <div class="col-lg-5">
                                <div class="title_right">
                                    <div class="col-md-8 col-sm-5 col-xs-12 form-group pull-right top_search" style="margin-top: -51px;margin-right: 25px;">
                                        <?= Html::submitButton('<i class="fa fa-plus"></i> Add', ['class' => 'btn btn-warning','name' => 'btnBulk','value' => 'add',]); ?>
                        ...
                        echo GridView::widget([
                            ...
                            'columns'      => [
                                ['class' => 'yii\grid\CheckboxColumn',
                                    'checkboxOptions' => function(User $user, $key, $index, $column) {
